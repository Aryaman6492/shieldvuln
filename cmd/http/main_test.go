...
import (
	...
	"github.com/Aryaman6492/shieldvuln/controllers"
	"github.com/Aryaman6492/shieldvuln/core/services"
...
func TestScan(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			repository := repositories.NewFakeAPIServerStorage("seclogic")
			...
			service := services.NewScanService(sbomAdapter, repository, cveAdapter, repository, platform, relevancyProvider, test.storage, false, true, false)
